...
try{
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(156, 80, 2));

        jPanel2.setBackground(new java.awt.Color(247, 208, 168));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            ...
            if(!category.equals("")){
            db.DbConnect.st.executeUpdate("insert into category_sales values('"+category+"')");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      int ri= table.getSelectedRow();
       ...
       try{
            ...
            db.DbConnect.st.executeUpdate("delete from category_sales where category='"+category+"'"); 
